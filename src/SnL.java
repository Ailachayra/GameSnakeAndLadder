...
public class SnL {
    ...
    public void play() {
        ...
        do {
            ...
            do {
                ...
                do {
                    ...
                    if (enter.isEmpty()) {
                        ...
                        Main.playDiceSound();  // pemutaran suara dadu
                    }
            ...
            Main.playGameEndSound();  // pemutaran kemenangan
    ...
    public void movePlayerAround(Player p, int x) {
        ...
        for (Ladder l : this.ladders) {
            if (p.getPosition() == l.getBottomPosition()) {
                ...
                Main.playLadderSound();  // pemutaran suara tangga
            }
        }
        for (Snake s : this.snakes) {
            if (p.getPosition() == s.getHeadPosition()) {
                ...
                Main.playSnakeSound();  // pemutaran suara ular
            }
        }
